...
function AppletObject ( ) 
{
    ...
    this.loading_message = 'Loading applet ...';
...
AppletObject.prototype.onstep = function(perc)
{
    this.alterElement( getElement( this.element_id ),
        '<div id="loadingDiv">Loading applet...' +
        '<div id="progressBar" style="width:'+ Math.floor(perc)+'%;' +
                    '">' +
            perc + "%" +
        '<'+'/div>' + '<'+'/div>' );
};
